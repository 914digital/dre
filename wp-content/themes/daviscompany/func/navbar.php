...
register_nav_menu('upper-bar', __('Top Navigation'));
register_nav_menu('lower-bar', __('Main Navigation'));
register_nav_menu('about-sidebar', __('About Sidebar'));
register_nav_menu('team-sidebar', __('Team Sidebar'));
register_nav_menu('prop-case-sidebar', __('Properties Case Studies Sidebar'));
register_nav_menu('prop-sidebar', __('Properties Sidebar'));